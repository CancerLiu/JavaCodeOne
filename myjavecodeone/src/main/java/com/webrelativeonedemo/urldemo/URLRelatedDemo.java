...
public class URLRelatedDemo {
    ...
    private void inetAddressTest() throws IOException {
        ...
        logger.info(inetLocal.getHostName() + "       " + Arrays.toString(inetLocal.getAddress()) + "     " + Arrays.toString(inetLocal.getAddress()) + "      " + inetLocal.getCanonicalHostName());
        logger.info(inetIp.getHostName() + "     " + inetIp.getCanonicalHostName() + "       " + inetIp.getHostAddress() + "     " + Arrays.toString(inetIp.getAddress()));
    ...
    private void URLDemo() throws IOException {
        ...
        logger.info("hostName:" + url.getHost() + "path:" + url.getPath() + "protocol:" + url.getProtocol() + "port:" + url.getPort() + "file:" + url.getFile());
        InputStream in = url.openStream();
        FileOutputStream out = new FileOutputStream(new File("E:\\My\\download\\firstPicture.jpg"));
